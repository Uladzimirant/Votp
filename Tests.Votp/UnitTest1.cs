...
//            {
//                    new Token() { Id = 1, User = user[0], RegistrationTime = DateTime.Now },
//                    new Token() { Id = 2, User = user[1], RegistrationTime = DateTime.Now },
//                    new Token() { Id = 3, User = user[2], RegistrationTime = DateTime.Now }
//            };
//        }
